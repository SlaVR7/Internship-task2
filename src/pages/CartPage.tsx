...
import { EmptyCart, NamedBanner, CartList } from '../components';
import { authorizedUser, store } from '../store/store.ts';
import { Button, Flex, Modal, Popconfirm, Row } from 'antd';
...
const CartPageComponent: FC = () => {
  ...
  return (
    <>
      ...
      >
        <Row>Please, sign in to your account or create a new one to place an order.</Row>
      </Modal>
      {currentCartProducts.length ? (
        <Flex justify={'center'}>
          <Flex vertical className={'w-full max-w-[1240px] py-[50px] px-[25px] md:px-[100px]'}>
