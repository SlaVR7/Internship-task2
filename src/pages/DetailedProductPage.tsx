          ...
          <div className="flex items-center flex-col md:flex-row md:justify-between md:items-start">
            <div style={{ width: '360px' }}>
              <Carousel autoplay>
                {product?.imageSrc.map((src) => {
                  return (
                    <div key={src} style={{ width: '360px' }}>
                      <Image.PreviewGroup items={product.imageSrc}>
                        <Image width={360} src={src} />
                      </Image.PreviewGroup>
                    </div>
                  );
                })}
            ...
            <div className="max-w-[400px] md:max-w-[60%] md:order-first">
                ...
                {product.salePrice ? (
                  <>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="h-min bg-red-500/90 text-primaryColor font-bold px-4 ml-8">
                        SALE
                      </div>
                    </div>
                  </>
              ...
              <div className="flex gap-[15px] flex-wrap">
                ...
                <Button onClick={() => product.removeFromCart()} disabled={!product.quantityInCart}>
                  Remove from cart
                </Button>
              </div>
            </div>
